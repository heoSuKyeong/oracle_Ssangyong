...
DELETE FROM tblmovieactoraward;
DELETE FROM tblmoviestaffaward;
DELETE FROM tblmovieost;
DELETE FROM tblost;
DELETE FROM tblmovieorigin;
DELETE FROM tblorigin;
DELETE FROM tblmakingcountry;
DELETE FROM tblmoviecountry;
DELETE FROM tblmoviegenre;
DELETE FROM tblgenres;
DELETE FROM tblmovieott;
DELETE FROM tblott;
...
DELETE FROM tblfilmography;
DELETE FROM tblactor;
DELETE FROM tblaward;
DELETE FROM tblinfo;
